  ...
  <tbody class="table-tbody">
    <tr class="table-row">
      ...
      <td class="table-col is-main" data-title="Name">
        <span role="button" tabindex="0" class="link"
          ><span class="text">airport.jpg</span></span
        >
      </td>
    ...
    <tr class="table-row">
      <td class="table-col is-only-desktop">
        <div class="image">
          <img class="avatar" width="30" height="30" src="" alt="" />
        </div>
      </td>
      <td class="table-col is-main" data-title="Name">
        <span role="button" tabindex="0" class="link"
          ><span class="text">Mobile illustration - dark.png</span></span
        >
      </td>
      <td class="table-col" data-title="Type">
        <span class="text">image/jpeg</span>

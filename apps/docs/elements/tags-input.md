...
<div class="tags-input is-disabled">
        ...
        <ul class="tags-list">
            <li class="tags-item">
                <div class="tag is-disabled">
                    <span class="tag-text">role:all</span>
                    <button class="tag-delete-button" aria-label="delete all:role tag" disabled>
                        <span class="icon-x" aria-hidden="true"></span>
                    </button>
                </div>
            </li>
    ...
    <input type="text" class="tags-input-text" placeholder="User ID, Team ID or Role" disabled>
</div>
```
...
<div class="tags-input is-readonly">
    ...
    <input type="text" class="tags-input-text u-hide" placeholder="User ID, Team ID or Role" readonly>
</div>
```
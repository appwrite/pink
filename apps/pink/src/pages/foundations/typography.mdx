...
We use a font scale to determine the size of the typography. The font sizes aligns well within the 4px grid system. The sizes are not directly matched with HTML tags to perserve semantics.

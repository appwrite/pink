...
We use a font scale to determine the size of the typography. The font sizes align well within the 4px grid system. The sizes are not directly matched with HTML tags to preserve semantics.

...
We use a font scale to determine the size of the typography. The font sizes fit well within the 4px grid. The sizes are not directly matched with HTML tags to perserve semantics.

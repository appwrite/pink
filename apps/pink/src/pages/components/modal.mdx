...
In Appwrite we are using modals mostly for creation or deletion of an object. A modal can include avatars, buttons, illustrations, lists, tags and text for example:

<div class="u-only-light u-margin-block-start-52">
  ![modal](/comparison/light/modal-usage-1.svg)
</div>

<div class="u-only-dark u-margin-block-start-52">
  ![modal](/comparison/dark/modal-usage-1.svg)
</div>

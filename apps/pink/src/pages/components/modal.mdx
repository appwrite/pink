...
In Appwrite we are using modals mostly for creation or deletion of an object. A modal can include avatars, buttons, illustrations, lists, tags and text for example:<br />

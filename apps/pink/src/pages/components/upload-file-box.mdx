...
<Preview noFlex>
  <div class="box is-border-dashed is-no-shadow u-padding-24" style="--box-border-radius:var(--border-radius-xsmall);">
    ...
    {/* <svg class="ants" width="100%" height="100%">
...
<Preview noFlex>
  <div class="box is-border-animated is-border-dashed-animated is-no-shadow u-padding-24" style="--box-border-radius:var(--border-radius-xsmall);" data-animate="true">
    <div class="upload-file-box">
      <div class="upload-file-box-image">
        <span class="icon-upload" aria-hidden="true"></span>
      </div>
    ...
    <svg class="dashes" width="100%" height="100%">
      <rect width='100%' height='100%' rx="4" ry="4" />
    </svg>

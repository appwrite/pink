...
<Preview noFlex>
  <div class="box is-border-animated is-no-shadow u-padding-24" style="--box-border-radius:var(--border-radius-xsmall);">
...
<Preview noFlex>
  <div class="box is-border-animated is-hover-with-file is-no-shadow u-padding-24" style="--box-border-radius:var(--border-radius-xsmall);" data-animate="true">
    <div class="upload-file-box">
      <div class="upload-file-box-image">
        <span class="icon-upload" aria-hidden="true"></span>
      </div>

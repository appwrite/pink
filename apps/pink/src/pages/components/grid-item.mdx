...
Grid items can be displayed multiple times by using the wrapper class `grid-box`:

<Preview>
<ul class="grid-box u-margin-auto" style="--grid-gap:2rem; --grid-item-size:18rem;">
    <li>
        <div class="card">
            <div class="grid-item-1">
                <div class="grid-item-1-start-start">

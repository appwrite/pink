...
Avatars in the Appwrite console has two different types:
...
Avatars in the Appwrite console has five different types:
...
Avatar groups in the Appwrite console has three different types:

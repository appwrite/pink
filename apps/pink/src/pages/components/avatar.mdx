...
| `is-color-empty` | Empty | Empty avatars can be used in cases you can't show an avatar, yet. For example, while an upload is pending. |
...
In the Appwrite console, apart from an empty avatar with a default gray color, you can find five more colors:

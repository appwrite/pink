---
title: Collapsible
description: Collapsibles are used to display a vertical list of headers that reveal or hide content. They allow to progressively disclose information as desired.
---

| Class                 | Type         |                                                      |
| --------------------- | ------------ | ---------------------------------------------------- |
| `collapsible`         | Collapsible  | Collapsible's representing class                     |

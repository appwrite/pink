---
title: Collapsible
description: Collapsible (or Accordion) is a vertically list of headers that reveal or hide content. Collapsibles allow users progressively disclose information as desired.
class: collapsible
---

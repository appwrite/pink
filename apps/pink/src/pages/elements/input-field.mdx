                        ...
                        <section class="drop-section">
                            <ul class="drop-list">
                                ...
                                <li class="drop-list-item">
                                    <button class="drop-button">
                                        <div class="u-flex u-cross-baseline u-gap-12">
                                            <span class="u-flex-basis-140 u-flex-shrink-0 u-text-start u-trim-start u-x-small u-color-text-gray">63f1efg6673515e4bc06</span>
        ...
        <ul class="form-list">
            ...
            <li class="form-item">
                ...
                <div class="input-text-wrapper">
                    <input
                        type="text"
                        class="input-text is-warning u-padding-inline-end-112"
                        placeholder="placeholder text"
                    />
                    <ul class="buttons-list u-cross-center u-position-absolute u-inset-block-start-8 u-inset-block-end-8 u-inset-inline-end-8">
                        ...
                        <li class="buttons-list-item u-margin-inline-start-8">
                            <label class="u-flex u-cross-center u-gap-8 u-margin-inline-start-8">
                                ...
                                <span class="u-x-small u-color-text-gray">NULL</span>
                            </label>
                        </li>
                    </ul>
                </div>
            ...
            <li class="form-item">
                ...
                <div class="input-text-wrapper">
                    <textarea class="input-text is-warning u-padding-block-end-32" placeholder="Type here..."></textarea>
                    <ul class="buttons-list u-cross-center u-position-absolute d u-inset-block-end-1 u-inset-inline-end-1 u-padding-8" style="border-end-end-radius:0.0625rem;">
                        <li class="buttons-list-item">
                            <span class="text-counter">
                                <span class="text-counter-count">4</span>
                                <span class="text-counter-separator"></span>

...
## Custom select
The options are made with ```drop-list``` partial. To hide them you can use the ```u-hide``` class name.
        ...
        <ul class="form-list">
            <li class="form-item">
                ...
                <div class="custom-select">
                    <button class="select u-width-full-line" type="button">
                        ...
                        <section class="drop-section">
                            ...
                            <div class="u-flex u-flex-vertical u-cross-center u-gap-24">
                                <button type="button" aria-label="create {target}">
                                    <img class="u-only-light" src="/empty-light.svg" alt="create" aria-hidden="true" height="124" width="215" />
                                    <img class="u-only-dark" src="/empty-dark.svg" alt="create" aria-hidden="true" height="124" width="215" />
                                </button>
                                <div class="u-text-center">
                                    <h2 class="heading-level-7 u-trim-1 u-margin-block-start-8">
                                        <span class="text">Sorry we couldn’t find ‘63f1ec68ac3515e4bc0663f1’</span>
                                    </h2>
                                    <p class="text u-margin-block-start-8">Need a hand? Check out our documentation.</p>
                                    </div>

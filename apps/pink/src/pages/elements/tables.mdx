...
| Class                    | Type                 |                                                                                                                 |
| ------------------------ | -------------------- | --------------------------------------------------------------------------------------------------------------- |
| `is-remove-outer-styles` | Without Outer Styles | Used in cases where the object created is not the main one. Mostly used inside a card (settings) or in wizards. |
...
| Class              | Type         |                                                                                                                       |
| ------------------ | ------------ | --------------------------------------------------------------------------------------------------------------------- |
| `is-sticky-scroll` | Inner Scroll | Used in case the first column of the table needs to be sticky for a table where the content exceeds the maximum width |
...
Scrolling tables without sticky column should be wrapped by `<div class="table-with-scroll">` and `<div class="table-wrapper">`.<br />

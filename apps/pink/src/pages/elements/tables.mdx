...
| Class                    | Type                 |                                                                                                                 |
| ------------------------ | -------------------- | --------------------------------------------------------------------------------------------------------------- |
| `is-remove-outer-styles` | Without Outer Styles | Secondary tables in the Appwrite console are mostly used inside a card or a wizard.                              |
...
| Class              | Type         |                                                                                                                       |
| ------------------ | ------------ | --------------------------------------------------------------------------------------------------------------------- |
| `is-sticky-scroll` | Inner Scroll | Used to make the first column of a table sticky when the rest of the table is scrollable horizontally.                |

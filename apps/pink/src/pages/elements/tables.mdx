...
| Class            | Type    |                                                 |
| ---------------- | ------- | ----------------------------------------------- |
| `table`          | Table   | Table's representing class                      |
...
Clickable rows allow you to use links as rows. It's useful when you want to maintain native browser behavior for links, like opening in a new tab.

---
title: Input Fields
description: Input fields provide a clear affordance for the user to enter and edit text, be easily discoverable, efficient and accessible. They typically appear in forms or dialogue modals.
---
...
A helper text provides assistance to the user in completing an input field. Use `helper` class to add a helper text below an input field.

...
Informative tags are used to visually label information for easy understanding and/or navigation. In the Appwrite console, we use system colors for each type of tag (gray, blue, green, orange, red) depending on context.<br />

...
In the Appwrite console, we use two styles of table:

| Class             | Type              | Description |
| ----------------- | ----------------- | ----------- |
| `table-thead`     | Table Head        | TBI         |
| `table-thead-col` | Table Head Column | TBI         |
| `table-tbody`     | Table Body        | TBI         |
| `table-row`       | Table Row         | TBI         |
| `table-col`       | Table Column      | TBI         |
...
| Class                    | Type                 | Description                                                                                                                              |
| ------------------------ | -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| -                        | Table                | The default table can have two or more columns. If the table width exceeds the size of the user’s screen, it should scroll horizontally. |
| `is-remove-outer-styles` | Without Outer Styles | TBI                                                                                                                                      |
| `is-sticky-scroll`       | Inner Scroll         | TBI                                                                                                                                      |
...
Scrolling tables need to be wrapped by a div with class `table-with-scroll` with another div with class `table-wrapper` inside.
...
Unsemantic tables allow you to use links as rows. This is useful for when you want to maintain native browser behavior for links, such as opening in a new tab.

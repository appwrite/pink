...
# Grid with Side - Filled with "adjust-content-to-cover"
...
<main class="grid-with-side">
    <header class="main-header">
        ...
        <div class="console-header">
            <div class="start">
                ...
                <button
                        class="button is-only-icon is-only-desktop"
            ...
            <div class="center">
                <a href="" class="is-no-desktop">
                    <img
                            ...
                            loading="lazy"
                            alt="Appwrite"
                            class="console-header-logo is-dark-mode"
                    />
                    <img
                            src="/packages/ui/images/appwrite.svg"
                            loading="lazy"
                            alt="Appwrite"
                            class="console-header-logo is-light-mode"
                    />
                </a>
            </div>
    ...
    <section class="main-content" style="background-color:#ddd">
        <div class="top-cover is-adjust-content-to-cover">
            <div class="container">
                <h1 class="main-title">Your Projects</h1>
                <p>Take advantage of the Appwrite APIs and tools.</p>
                <ul class="links-nav">
